 ...
 * @desc
 */
public class AFilter implements  ExternalGLThread.Renderer {
    ...
    double width,height;
    public void setBitmap(Bitmap bitmap,double width,double height){
        this.mBitmap=bitmap;
        this.width=width;
        this.height=height;
    }
    ...
    public void onCreate() {
        ...
        mProgram=AShaderUtils.createProgram(mContext.getResources(),vertex,fragment);
